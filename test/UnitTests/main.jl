...
@testset verbose = true "Main" begin
    ...
    expected_prod = Signomial(
        ...
        [Rational{Int64}[0, 2], Rational{Int64}[1, 1],
            ...
            Rational{Int64}[10, 1], Rational{Int64}[10, 2]]; sorted = true)
    ...
    @testset verbose = true "linear_regions repeated-map path via f/f — 6 monomials" begin
    ...
    @testset verbose = true "linear_regions repeated-map path via f/f — 2D, 6 monomials" begin
