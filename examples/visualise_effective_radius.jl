...
# Obtain the CairoMakie figure and axis containing the linear regions of the
...
CairoMakie.lines!(ax,[er,er,-er,-er,er],[er,-er,-er,er,er],color=:blue)

# save the plot
CairoMakie.save("./examples/outputs/effective_radius.png",fig)