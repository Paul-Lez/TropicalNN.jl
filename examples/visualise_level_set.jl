...
f=Signomial(Rational{BigInt}.([-3723308421248693//288230376151711744,73114227503219//140737488355328,-747885935752887//1125899906842624,4648013016134511//4503599627370496]),[Rational{BigInt}.([3378591440196385//4503599627370496, 2316848943565215//4503599627370496]),Rational{BigInt}.([-1429525263752149//2251799813685248, -896638549896579//9007199254740992]),Rational{BigInt}.([-2508142725340491//4503599627370496, -4491348586605881//9007199254740992]),Rational{BigInt}.([1437914608837039//18014398509481984, 8253797924747951//9007199254740992])],false)

# Plot the linear regions with the level set of 0.5 identified in red
fig,ax=plot_linear_regions(f,level_set_value=0.5)
CairoMakie.save("./examples/outputs/tropical_polynomial_nonzero_level_set.png",fig)

# We identify that an entire polyhedron lies in the level set by
# highlighting each of its edges in red
f=Signomial(Rational{BigInt}.([0,73114227503219//140737488355328,-747885935752887//1125899906842624,4648013016134511//4503599627370496]),[Rational{BigInt}.([0,0]),Rational{BigInt}.([-1429525263752149//2251799813685248,-896638549896579//9007199254740992]),Rational{BigInt}.([-2508142725340491//4503599627370496,-4491348586605881//9007199254740992]),Rational{BigInt}.([1437914608837039//18014398509481984,8253797924747951//9007199254740992])],false)
