...
GLMakie.save("./package/examples/outputs/tropical_polynomial_nonzero_level_set.png",fig)
...
GLMakie.save("./package/examples/outputs/tropical_polynomial_zero_level_set.png",fig)