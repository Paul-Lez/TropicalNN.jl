...
CairoMakie.save("./examples/outputs/one_variable_tropical_polynomial_regions_bounded.png", fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig, ax=plot_linear_regions(pmap)
CairoMakie.save("./examples/outputs/one_variable_tropical_polynomial_regions_full.png", fig)
## Linear Maps
### Visualise linear maps acting on the linear regions in the region [-1,1]
fig, ax=plot_linear_maps(pmap, bounding_box = Dict(1 => [-1, 1]))
CairoMakie.save("./examples/outputs/one_variable_tropical_polynomial_maps_bounded.png", fig)
...
CairoMakie.save("./examples/outputs/one_variable_tropical_polynomial_maps_full.png", fig)
...
CairoMakie.save("./examples/outputs/two_variables_tropical_polynomial_regions_bounded.png", fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig, ax=plot_linear_regions(pmap)
CairoMakie.save("./examples/outputs/two_variables_tropical_polynomial_regions_full.png", fig)
## Linear Maps
...
CairoMakie.save("./examples/outputs/two_variables_tropical_polynomial_maps_bounded.png", fig)
### Visualise linear maps acting on the linear regions in a region encompasing all of the polynomial's linear regions
fig, ax=plot_linear_maps(pmap)
CairoMakie.save("./examples/outputs/two_variables_tropical_polynomial_maps_full.png", fig)
...
fig, ax=plot_linear_regions(
    pmap, bounding_box = Dict(1 => [-1, 1], 2 => [-1, 1], 3 => [-1, 1]),
    rot_matrix = [1 0 0; 0 1 0; 0 0 1])
CairoMakie.save("./examples/outputs/three_variables_tropical_polynomial_regions_bounded.png", fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig, ax=plot_linear_regions(pmap, rot_matrix = [1 0 0; 0 1 0; 0 0 1])
CairoMakie.save("./examples/outputs/three_variables_tropical_polynomial_regions_full.png", fig)
## Linear Maps
