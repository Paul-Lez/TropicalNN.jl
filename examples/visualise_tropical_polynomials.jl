...
GLMakie.save("./package/examples/outputs/one_variable_tropical_polynomial_regions_bounded.png",fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig,ax=plot_linear_regions(pmap)
GLMakie.save("./package/examples/outputs/one_variable_tropical_polynomial_regions_full.png",fig)
## Linear Maps
### Visualise linear maps acting on the linear regions in the region [-1,1]
fig,ax=plot_linear_maps(pmap,bounding_box=Dict(1 => [-1,1]))
GLMakie.save("./package/examples/outputs/one_variable_tropical_polynomial_maps_bounded.png",fig)
...
GLMakie.save("./package/examples/outputs/one_variable_tropical_polynomial_maps_full.png",fig)
...
GLMakie.save("./package/examples/outputs/two_variables_tropical_polynomial_regions_bounded.png",fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig,ax=plot_linear_regions(pmap)
GLMakie.save("./package/examples/outputs/two_variables_tropical_polynomial_regions_full.png",fig)
## Linear Maps
...
GLMakie.save("./package/examples/outputs/two_variables_tropical_polynomial_maps_bounded.png",fig)
### Visualise linear maps acting on the linear regions in a region encompasing all of the polynomial's linear regions
fig,ax=plot_linear_maps(pmap)
GLMakie.save("./package/examples/outputs/two_variables_tropical_polynomial_maps_full.png",fig)
...
GLMakie.save("./package/examples/outputs/three_variables_tropical_polynomial_regions_bounded.png",fig)
### Visualise linear regions in a region encompasing all of the polynomial's linear regions
fig,ax=plot_linear_regions(pmap,rot_matrix=[1 0 0;0 1 0;0 0 1])
GLMakie.save("./package/examples/outputs/three_variables_tropical_polynomial_regions_full.png",fig)
## Linear Maps
